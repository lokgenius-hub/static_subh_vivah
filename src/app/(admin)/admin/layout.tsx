...
import { LayoutDashboard, Phone, Users, Settings, Shield, BookOpen, Home, Mail, Package, Menu, X } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          <aside className="relative flex flex-col w-72 bg-[var(--color-charcoal)] h-full overflow-y-auto shadow-xl">
            ...
            <div className="p-4 border-t border-gray-700 space-y-3">
              ...
              <div className="flex items-center justify-between">
                <Link href="/" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 text-xs text-gray-500 hover:text-gray-300">
                  <Home className="h-3 w-3" /> Back to site
                </Link>
                <SignOutButton className="flex items-center gap-1.5 text-xs text-red-400 hover:text-red-300 transition-colors" />
              </div>
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="lg:hidden bg-[var(--color-charcoal)] px-4 py-3 flex items-center justify-between">
          <button onClick={() => setMobileMenuOpen(true)} className="text-white p-1 -ml-1">
